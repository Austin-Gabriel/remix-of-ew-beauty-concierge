...
Domain folder for **messaging** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the messaging domain go in this folder.
...
- Pure utilities/hooks scoped to messaging also live here. App-wide utilities go in `src/lib/`.
