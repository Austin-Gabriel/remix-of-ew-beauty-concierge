...
Domain folder for **services** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the services domain go in this folder.
...
- Pure utilities/hooks scoped to services also live here. App-wide utilities go in `src/lib/`.
