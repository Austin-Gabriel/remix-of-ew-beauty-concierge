...
Domain folder for **notifications** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the notifications domain go in this folder.
...
- Pure utilities/hooks scoped to notifications also live here. App-wide utilities go in `src/lib/`.
