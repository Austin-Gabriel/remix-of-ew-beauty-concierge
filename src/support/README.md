...
Domain folder for **support** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the support domain go in this folder.
...
- Pure utilities/hooks scoped to support also live here. App-wide utilities go in `src/lib/`.
