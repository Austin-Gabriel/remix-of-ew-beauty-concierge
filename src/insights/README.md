...
Domain folder for **insights** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the insights domain go in this folder.
...
- Pure utilities/hooks scoped to insights also live here. App-wide utilities go in `src/lib/`.
