...
Domain folder for **profile** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the profile domain go in this folder.
...
- Pure utilities/hooks scoped to profile also live here. App-wide utilities go in `src/lib/`.
