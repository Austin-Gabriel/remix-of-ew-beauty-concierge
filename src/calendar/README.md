...
Domain folder for **calendar** features. Currently a placeholder — no code lives here yet.

## When you add code here
- UI components for the calendar domain go in this folder.
...
- Pure utilities/hooks scoped to calendar also live here. App-wide utilities go in `src/lib/`.
